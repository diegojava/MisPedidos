...
public class Login extends Activity implements OnClickListener {
    ...
    private static final String LOGIN_URL = "http://mispedidos.x10.bz/app/login.php";
    ...
    class AttemptLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                Log.d("Iniciando sesión...", json.toString());

                // json success tag
                success = json.getInt(TAG_SUCCESS);
                if (success == 1) {
                    Log.d("Sesión iniciada!", json.toString());
                    // save user data
                    ...
                    Log.d("Intenta de nuevo!", json.getString(TAG_MESSAGE));
                    return json.getString(TAG_MESSAGE);
                }
